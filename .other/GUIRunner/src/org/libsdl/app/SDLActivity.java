...
import person.wangchen11.guirunner.FileWork;
...
public class SDLActivity extends Activity {
    ...
    protected String[] getLibraries() {
    	if( DebugInfo.mSoPath==null || DebugInfo.mSoPath.length()==0 )
        return new String[] {
            "SDL2",
            "SDL2_image",
            "SDL2_mixer",
        ...
        try {
            ...
            //wangchen11 patch begin
        	{
        		if(DebugInfo.mSoPath!=null&&DebugInfo.mSoPath.length()>0){
        			...
        			System.load(localSo);
        			nativeSetAssetsPath(DebugInfo.mAssetsPath);
        		}
        	}
    ...
    //wangchen11 patch begin
    public static native void nativeSetAssetsPath(String assetsPath);
    //wangchen11 patch end
    /**
